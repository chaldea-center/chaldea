...
void main() {
  ...
  testWidgets('renders subtitle when provided', (tester) async {
    await pumpRow(
      tester,
      const InfoRow(title: 'T', subtitle: 'sub text'),
    );
  ...
  testWidgets('shows chevron when showChevron=true', (tester) async {
    await pumpRow(
      tester,
      const InfoRow(title: 'T', showChevron: true),
    );
  ...
  testWidgets('prominence.title makes title large + subtitle small (default)', (tester) async {
    await pumpRow(
      tester,
      const InfoRow(title: 'TitleText', subtitle: 'SubText'),
    );
  ...
  testWidgets('prominence.subtitle inverts title/subtitle sizing', (tester) async {
    await pumpRow(
      ...
      const InfoRow(
        title: 'Label',
        subtitle: 'ValueBig',
        prominence: InfoRowProminence.subtitle,
      ),
    );
