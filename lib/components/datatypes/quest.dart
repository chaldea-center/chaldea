...
class Quest {
  ...
  static LocalizedGroup get questNameGroup => const LocalizedGroup([
        ...
        LocalizedText(
            chs: '剑之修炼场',
            jpn: '剣の修練場',
            eng: 'Saber Training Ground',
            kor: '검의 수련장'),
        LocalizedText(
            chs: '弓之修炼场',
            jpn: '弓の修練場',
            eng: 'Archer Training Ground',
            kor: '궁의 수련장'),
        LocalizedText(
            chs: '枪之修炼场',
            jpn: '槍の修練場',
            eng: 'Lancer Training Ground',
            kor: '창의 수련장'),
        LocalizedText(
            chs: '狂之修炼场',
            jpn: '狂の修練場',
            eng: 'Berserker Training Ground',
            kor: '광의 수련장'),
        LocalizedText(
            chs: '骑之修炼场',
            jpn: '騎の修練場',
            eng: 'Rider Training Ground',
            kor: '기의 수련장'),
        LocalizedText(
            chs: '术之修炼场',
            jpn: '術の修練場',
            eng: 'Caster Training Ground',
            kor: '술의 수련장'),
        LocalizedText(
            chs: '杀之修炼场',
            jpn: '殺の修練場',
            eng: 'Assassin Training Ground',
            kor: '살의 수련장'),
  ...
  static LocalizedGroup get _emberClsNameGroup => const LocalizedGroup([
        ...
        LocalizedText(
            chs: '枪·杀', jpn: '槍·殺', eng: 'Lancer/Assassin', kor: '창/살'),
