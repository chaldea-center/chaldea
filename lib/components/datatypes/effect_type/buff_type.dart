...
class BuffType with FuncBuffTypeBase {
  final int index;
  @override
  final String type;
  final String nameCn;
  final String nameJp;
  final String nameEn;
  final bool Function(NiceBuff)? test;
  ...
  factory BuffType._(
    ...
    BuffType? _one = all[type];
    if (_one == null) {
      return all[type] =
          BuffType._real(index, type, nameCn, nameJp, nameEn, test);
    } else {
