...
class EffectType {
  ...
  static EffectType gainStar = EffectType(
    ...
    name: const LocalizedText(chs: '暴击星获得', jpn: 'スター獲得', eng: 'Gain Stars', kor: '스타 획득'),
  );
  ...
  static EffectType regainStar = EffectType(
    ...
    name: const LocalizedText(
        chs: '每回合暴击星', jpn: '毎ターンスター獲得', eng: 'Stars per Turn', kor: '턴 마다 스타 획득'),
  );

  static EffectType gainHp = EffectType(
    key: 'gainHp',
    funcs: [FuncTypes.gainHp, FuncTypes.gainHpPer, FuncTypes.gainHpFromTargets],
    name: const LocalizedText(chs: 'HP回复', jpn: 'HP回復', eng: 'Restore HP', kor: 'HP 회복'),
  );
  ...
  static EffectType gainNp = EffectType(
    ...
    name: const LocalizedText(chs: 'NP増加', jpn: 'NP増加', eng: 'Charge NP', kor: 'NP 획득'),
  );
  ...
  static EffectType pierceDefence = EffectType(
    ...
    name: const LocalizedText(chs: '无视防御', jpn: '防御無視', eng: 'Pierce Defense', kor: '방어 상태 무시'),
  );
  ...
  static EffectType friendPointUp = EffectType(
    ...
    name: const LocalizedText(chs: '友情点', jpn: 'フレンドポイント', eng: 'Friend Point', kor: '우정 포인트'),
  );
  ...
  static EffectType userEquipExpUp = EffectType(
    ...
    name: const LocalizedText(chs: '魔术礼装', jpn: '魔術礼装', eng: 'Mystic Code', kor: '마술예장 EXP'),
  );
  ...
  static EffectType regainNp = EffectType(
    ...
    name: const LocalizedText(chs: '每回合NP', jpn: '毎ターンNP', eng: 'NP per turn', kor: '턴 마다 NP 획득'),
  );

  static EffectType regainHp = EffectType(
    key: 'regainHp',
    buffs: [BuffTypes.regainHp],
    name: const LocalizedText(chs: '每回合HP', jpn: '毎ターンHP', eng: 'HP per turn', kor: '턴 마다 HP 회복'),
  );

  static EffectType upAtk = EffectType(
    key: 'upAtk',
    buffs: [BuffTypes.upAtk],
    name: const LocalizedText(chs: '攻击力', jpn: '攻撃力', eng: 'Attack Up', kor: '공격력 상승'),
  );

  static EffectType upDamage = EffectType(
    key: 'upDamage',
    buffs: [BuffTypes.upDamage, BuffTypes.upDamageIndividualityActiveonly],
    name: const LocalizedText(chs: '威力提升', jpn: '威力アップ', eng: 'SP.DMG Up', kor: '크리티컬 위력 상승'),
  );
  ...
  static EffectType npDamage = EffectType(
    ...
    name: const LocalizedText(chs: '宝威', jpn: '宝具威力', eng: 'NP Damage Up', kor: '보구 위력 상승'),
  );

  static EffectType upDropnp = EffectType(
    key: 'upDropnp',
    buffs: [BuffTypes.upDropnp, BuffTypes.upDamagedropnp],
    name: const LocalizedText(chs: 'NP获得率', jpn: 'NP獲得率', eng: 'NP Gain Up', kor: 'NP 획득률 상승'),
  );
  ...
  static EffectType upTolerance = EffectType(
    ...
    name:
        const LocalizedText(chs: '耐性提升', jpn: '耐性アップ', eng: 'Debuff Tolerance', kor: '약체 내성 상승'),
  );
  ...
  static EffectType donotSkill = EffectType(
    ...
    name: const LocalizedText(chs: '技能封印', jpn: 'スキル封印', eng: 'Skill Seal', kor: '스킬 사용 불가'),
  );

  static EffectType donotNoble = EffectType(
    key: 'donotNoble',
    buffs: [BuffTypes.donotNoble],
    name: const LocalizedText(chs: '宝具封印', jpn: '宝具封印', eng: 'NP Seal', kor: '보구 사용 불가'),
  );
  ...
  static EffectType upHate = EffectType(
    ...
    name: const LocalizedText(chs: '目标集中度', jpn: 'タゲ集中', eng: 'Taunt', kor: '타겟 집중'),
  );

  static EffectType upDefence = EffectType(
    key: 'upDefence',
    buffs: [BuffTypes.upDefence],
    name: const LocalizedText(chs: '防御力提升', jpn: '防御力アップ', eng: 'Defence Up', kor: '방어력 상승'),
  );
  ...
  static EffectType avoidInstantdeath = EffectType(
    ...
    name: const LocalizedText(chs: '即死无效', jpn: '即死無効', eng: 'Immune to Death', kor: '즉사 면역'),
  );
  ...
  static EffectType resistInstantdeath = EffectType(
    ...
    name: const LocalizedText(chs: '即死耐性', jpn: '即死耐性', eng: 'Death Resist', kor: '즉사 저항'),
  );
  ...
  static EffectType entryFunction = EffectType(
    ...
    name: const LocalizedText(chs: '登场时发动', jpn: '登場時発動', eng: 'Skill on Dead', kor: '등장시 발동'),
  );
  ...
  static EffectType upGainHp = EffectType(
    ...
    name: const LocalizedText(chs: 'HP回复量', jpn: 'HP回復量', eng: 'Healing Up', kor: '회복량 증가'),
  );
  ...
  static EffectType upToleranceSubstate = EffectType(
    ...
    name: const LocalizedText(
        chs: '强化解除耐性', jpn: '強化解除耐性', eng: 'Buff Removal Resistance', kor: '강화 해제 저항'),
  );
  ...
  static EffectType fieldIndividuality = EffectType(
    ...
    name: const LocalizedText(
        chs: '场地特性赋予', jpn: 'フィールドセット', eng: 'Change Field Type', kor: '필드 상태 변화'),
  );
