    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(
              text: LocalizedText.of(chs: '打分', jpn: 'スコアリング', eng: 'Rating', kor: '스코어링'),
            ),
            Tab(
              text:
                  LocalizedText.of(chs: '期望值', jpn: '期待値', eng: 'Expectation', kor: '기대치'),
            )
          ],
        ),
      ),
    ...
    switch (score) {
      case 1:
        return LocalizedText.of(
            chs: '非常不想要', jpn: '本当に不要', eng: 'Really Unwanted', kor: '정말로 불필요함');
      // case 2:
      // case 3:
      // case 4:
      case 5:
              ...
              Expanded(
                child: _underline(
                  TextButton(
                    ...
                    child: Text(
                      LocalizedText.of(chs: '期望', jpn: '期待値', eng: 'Exp.', kor: '기대치'),
                      maxLines: 1,
                      overflow: TextOverflow.visible,
                    ),
                  ),
