                ...
                ? Padding(
                    ...
                    child: Column(
                      children: [
                        Text(
                          LocalizedText.of(
                              chs: '使用方法', jpn: '使用方法について', eng: 'How to use', kor: '사용 방법'),
      ...
      children: [
        SliverPinnedHeader(
          child: ListTile(
            ...
            title:
                Text(LocalizedText.of(chs: '账号信息', jpn: 'jpn', eng: 'Account', kor: '계정')),
        ...
        if (_showAccount)
          SliverClip(
            child: MultiSliver(children: [
              ListTile(
                title:
                    Text(LocalizedText.of(chs: '获取时间', jpn: '時間', eng: 'Time', kor: '시간')),
                trailing:
              ...
              ListTile(
                ...
                trailing: Text(user.genderType == 1
                    ? '♂' +
                        LocalizedText.of(chs: '咕哒夫', jpn: 'ぐだ男', eng: 'Gudao', kor: '구다오')
                    : '♀' +
                        LocalizedText.of(
      ...
      for (var svt in group) {
        ...
        List<Widget> infoRows = [
          ...
          _wrapCellStyle([
            ...
            coin == null
                ? ''
                : (LocalizedText.of(chs: '硬币', jpn: 'コイン', eng: 'Coin', kor: '코인') +
                    ' $coin'),
          ]),
          _wrapCellStyle([
      ...
      final error = await SimpleDialog(
        ...
        children: [
          ListTile(
            ...
            title: Text(LocalizedText.of(
                chs: '从剪切板', jpn: 'クリップボードから', eng: 'From Clipboard', kor: '클립보드에서')),
            onTap: () async {
              try {
                String? text =
          ...
          ListTile(
            ...
            title: Text(LocalizedText.of(
                chs: '从文本文件', jpn: 'テキストファイルから', eng: 'From Text File', kor: '텍스트 파일에서')),
            onTap: () async {
              try {
                final result =
