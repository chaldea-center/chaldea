// ModernStateColors: semantic state colors (success/warning/info/danger) for
...
class ModernStateColors {
  ...
  factory ModernStateColors.of(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final bgAlpha = isDark ? 40 : 25;
    final cs = Theme.of(context).colorScheme;
    return ModernStateColors._(
