...
class BlankPage extends StatelessWidget {
  ...
  const BlankPage({super.key, this.showIndicator = false, this.indicatorBuilder = _defaultIndicatorBuilder});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget img = const Image(image: AssetImage("res/img/chaldea.png"), filterQuality: FilterQuality.high);
