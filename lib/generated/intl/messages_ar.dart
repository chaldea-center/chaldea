...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(n, total) => "كريستال الى لور : ${n}";
  ...
  static String m7(n) => "القسم ${n}";

  static String m8(region) => "${region} ميّز";

  static String m9(n) => "إعادة الخطة ${n}(All)";

  static String m10(n) => "إعادة الخطة${n}(Shown)";

  static String m11(n) => "الملف الشخصي ${n}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "add_feedback_details_warning": MessageLookupByLibrary.simpleMessage("رجاءا ،أضف تفاصيل إلى المرجعية"),
        "add_mission": MessageLookupByLibrary.simpleMessage("اضافة مهمة"),
        "add_to_blacklist": MessageLookupByLibrary.simpleMessage("ضف الى اللائحة السوداء"),
        ...
        "app_data_folder": MessageLookupByLibrary.simpleMessage("مجلد البيانات"),
        "app_data_use_external_storage": MessageLookupByLibrary.simpleMessage("استخدم تخزين خارجي (بطاقة SD)"),
        "append_skill": MessageLookupByLibrary.simpleMessage("الباسيڨ سكيل"),
        "append_skill_short": MessageLookupByLibrary.simpleMessage("باسيف سكيل"),
        ...
        "attach_help":
            MessageLookupByLibrary.simpleMessage("اذا كنت تواجه مشكله في اختيار الصور، اختر ملفات بدلا عن ذلك"),
        ...
        "backup_failed": MessageLookupByLibrary.simpleMessage("فشل النسخ الاحتياطي"),
        "backup_history": MessageLookupByLibrary.simpleMessage("تاريخ النسخ الاحتياطي"),
        ...
        "bootstrap_page_title": MessageLookupByLibrary.simpleMessage("الصفحة التمهيدية"),
        ...
        "card_asset_chara_figure": MessageLookupByLibrary.simpleMessage("الشخصية"),
        "card_asset_command": MessageLookupByLibrary.simpleMessage("الكوماند كارد"),
        "card_asset_face": MessageLookupByLibrary.simpleMessage("الصورة المصغرة"),
        "card_asset_narrow_figure": MessageLookupByLibrary.simpleMessage("تكوين"),
        ...
        "chaldea_backup": MessageLookupByLibrary.simpleMessage("النسخ الاحتياطي لتطبيق كاليديا"),
        ...
        "clear_cache": MessageLookupByLibrary.simpleMessage("مسح ذاكرة التخزين المؤقت"),
        "clear_cache_finish": MessageLookupByLibrary.simpleMessage("ذاكرة التخزين المؤقت تم مسحها"),
        "clear_cache_hint": MessageLookupByLibrary.simpleMessage("يشمل الصور والصوتيات"),
        "clear_data": MessageLookupByLibrary.simpleMessage("حذف البيانات"),
        "coin_summon_num": MessageLookupByLibrary.simpleMessage("عملات الاستدعاء"),
        ...
        "create_account_textfield_helper":
            MessageLookupByLibrary.simpleMessage("يمكنك إضافة المزيد من الحسابات لاحقا في الاعدادات"),
        "create_duplicated_svt": MessageLookupByLibrary.simpleMessage("اصنع تكرار"),
        "cur_account": MessageLookupByLibrary.simpleMessage("الحساب الحالي"),
        "current_": MessageLookupByLibrary.simpleMessage("حالي"),
        "current_version": MessageLookupByLibrary.simpleMessage("النسخة الحالية"),
        "custom_mission": MessageLookupByLibrary.simpleMessage("مهمة مخصصة"),
        "custom_mission_nothing_hint": MessageLookupByLibrary.simpleMessage("لا مهام اضغط + لأضافة مهمة"),
        "custom_mission_source_mission": MessageLookupByLibrary.simpleMessage("مصدر المهمة"),
        ...
        "display_setting": MessageLookupByLibrary.simpleMessage("إعدادات العرض"),
        "display_show_window_fab": MessageLookupByLibrary.simpleMessage("عرض زر النوافذ المتعددة"),
        "done": MessageLookupByLibrary.simpleMessage("تم"),
        "download": MessageLookupByLibrary.simpleMessage("تحميل"),
        "download_latest_gamedata_hint":
            MessageLookupByLibrary.simpleMessage("لضمان التوافق الرجاء تحديث آخر نسخة من التطبيق قبل تحديث البيانات"),
        "download_source": MessageLookupByLibrary.simpleMessage("مصدر التحميل"),
        "download_source_hint": MessageLookupByLibrary.simpleMessage("تحديث حزمة البيانات والتطبيق"),
        "downloaded": MessageLookupByLibrary.simpleMessage("تم التحميل"),
        "downloading": MessageLookupByLibrary.simpleMessage("جاري التحميل"),
        "drop_calc_empty_hint": MessageLookupByLibrary.simpleMessage("اضغط + لإضافة عنصر"),
        ...
        "effective_condition": MessageLookupByLibrary.simpleMessage("شرط التأثير"),
        ...
        "efficiency_type_drop": MessageLookupByLibrary.simpleMessage("نسبة الدروب"),
        ...
        "enemy_filter_trait_hint":
            MessageLookupByLibrary.simpleMessage("فلتر العلامة \"ترايت\" يستخدم فقط للفري كويست من القصة الأساسية."),
        "enemy_leader_hint": MessageLookupByLibrary.simpleMessage("القائد : تنتهي المعركة اذا تمت هزيمته"),
        ...
        "enhance_warning": MessageLookupByLibrary.simpleMessage("سيتم استهلاك العناصر التالية للتطوير"),
        ...
        "event_treasure_box": MessageLookupByLibrary.simpleMessage("بطاقة استبدال"),
        "exchange_count": MessageLookupByLibrary.simpleMessage("حساب المبادلة"),
        "exchange_ticket": MessageLookupByLibrary.simpleMessage("تذكرة المبادلة"),
        "exchange_ticket_short": MessageLookupByLibrary.simpleMessage("التذكرة"),
        ...
        "exp_card_same_class": MessageLookupByLibrary.simpleMessage("نفس الكلاس"),
        ...
        "feedback_add_attachments": MessageLookupByLibrary.simpleMessage("أضف لقطات شاشة او ملف مرفق"),
        "feedback_contact": MessageLookupByLibrary.simpleMessage("معلومات التواصل"),
        "feedback_content_hint": MessageLookupByLibrary.simpleMessage("المرجعية والاقتراحات"),
        ...
        "free_quest_calculator_short": MessageLookupByLibrary.simpleMessage("فري كويست"),
        "gacha_prob_custom_rate": MessageLookupByLibrary.simpleMessage("نسبة مخصصة"),
        ...
        "game_data_not_found":
            MessageLookupByLibrary.simpleMessage("فشل تحميل بيانات اللعبة ، الرجاء تحميل البيانات مجددا"),
        ...
        "glpk_error_no_valid_target": MessageLookupByLibrary.simpleMessage("مدخلات خاطئة او المدخلات غير موجودة"),
        ...
        "import_screenshot_update_items": MessageLookupByLibrary.simpleMessage("تحديث العناصر"),
        "import_source_file": MessageLookupByLibrary.simpleMessage("استورد ملف المصدر"),
        ...
        "info_bond_points_sum": MessageLookupByLibrary.simpleMessage("الإجمالي"),
        "info_cards": MessageLookupByLibrary.simpleMessage("بطاقات"),
        "info_critical_rate": MessageLookupByLibrary.simpleMessage("نسبة الكريتكال"),
        ...
        "input_invalid_hint": MessageLookupByLibrary.simpleMessage("مدخلات غير صالحة"),
        ...
        "item_no_free_quests": MessageLookupByLibrary.simpleMessage("لا فري كويستز"),
        ...
        "login_new_password": MessageLookupByLibrary.simpleMessage("كلمة سر جديدة"),
        "login_password": MessageLookupByLibrary.simpleMessage("كلمة سر"),
        "login_password_error":
            MessageLookupByLibrary.simpleMessage("يجب ان تحتوي على حروف وأرقام وألا تقل عن أربعة خانات"),
        ...
        "long_press_to_save_hint": MessageLookupByLibrary.simpleMessage("ضغطة مطولة للحفط"),
        ...
        "lucky_bag_tooltip_unwanted": MessageLookupByLibrary.simpleMessage("الغير مطلوب"),
        "lucky_bag_tooltip_wanted": MessageLookupByLibrary.simpleMessage("المطلوب"),
        ...
        "no_servant_quest_hint": MessageLookupByLibrary.simpleMessage("لا يوجد رانك اب او مهمة"),
        "no_servant_quest_hint_subtitle": MessageLookupByLibrary.simpleMessage("اضغط ♡ لعرض جميع مهام الخدم"),
        "noble_phantasm": MessageLookupByLibrary.simpleMessage("الوهم النبيل"),
        "noble_phantasm_level": MessageLookupByLibrary.simpleMessage("الوهم النبيل"),
        ...
        "np_gain_mod": MessageLookupByLibrary.simpleMessage("غير منتهية الصلاحية"),
        ...
        "open_in_file_manager": MessageLookupByLibrary.simpleMessage("رجاءا افتح باسخدام مدير الملفات"),
        ...
        "save_to_photos": MessageLookupByLibrary.simpleMessage("الحفظ في الصور"),
        ...
        "select_copy_plan_source": MessageLookupByLibrary.simpleMessage("تحديد مصدر النسخ"),
        "select_item_title": MessageLookupByLibrary.simpleMessage("اختيار عنصر"),
        "select_lang": MessageLookupByLibrary.simpleMessage("اختيار اللغة"),
        "select_plan": MessageLookupByLibrary.simpleMessage("تحديد خطة"),
        "send_email_to": MessageLookupByLibrary.simpleMessage("إرسال البريد الى"),
        ...
        "servant_detail_page": MessageLookupByLibrary.simpleMessage("صفحة تفاصيل الخادم"),
        "servant_list_page": MessageLookupByLibrary.simpleMessage("صفحة قائمة الخدم"),
        "set_plan_name": MessageLookupByLibrary.simpleMessage("اعداد اسم الخطة"),
        "setting_always_on_top": MessageLookupByLibrary.simpleMessage("دائما في الأعلى"),
        "setting_auto_rotate": MessageLookupByLibrary.simpleMessage("تدوير تلقائي"),
        "setting_setting_favorite_button_default": MessageLookupByLibrary.simpleMessage("الزر المفضل الافتراضي"),
        "setting_show_account_at_homepage": MessageLookupByLibrary.simpleMessage("عرض الحساب في الصفحة الرئيسية"),
        "setting_tabs_sorting": MessageLookupByLibrary.simpleMessage("تصنيف الصفحات"),
        ...
        "show_frame_rate": MessageLookupByLibrary.simpleMessage("عرض نسبة الاطارات"),
        "show_fullscreen": MessageLookupByLibrary.simpleMessage("عرض ملئ الشاشة"),
        "show_outdated": MessageLookupByLibrary.simpleMessage("عرض المنتهى منه"),
        ...
        "summon_show_banner": MessageLookupByLibrary.simpleMessage("عرض البانر"),
        "summon_ticket_short": MessageLookupByLibrary.simpleMessage("تكت"),
        "support_chaldea": MessageLookupByLibrary.simpleMessage("الدعم والتبرعات"),
        "svt_ascension_icon": MessageLookupByLibrary.simpleMessage("ايقونه الاسينشن"),
        "svt_attribute": MessageLookupByLibrary.simpleMessage("التنسيق"),
        ...
        "svt_fav_btn_show_all": MessageLookupByLibrary.simpleMessage("عرض الكل"),
        "svt_fav_btn_show_favorite": MessageLookupByLibrary.simpleMessage("عرض المفضلة"),
        ...
        "toggle_dark_mode": MessageLookupByLibrary.simpleMessage("بدل الى الوضع المظلم"),
        "tooltip_refresh_sliders": MessageLookupByLibrary.simpleMessage("تحديث الشرائح"),
        ...
        "update_already_latest": MessageLookupByLibrary.simpleMessage("النسخة الاعلي مسبقا"),
        "update_dataset": MessageLookupByLibrary.simpleMessage("تحديث حزمة البيانات"),
        ...
        "view_illustration": MessageLookupByLibrary.simpleMessage("عرض الرسومية"),
