...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "ad": MessageLookupByLibrary.simpleMessage("廣告"),
    ...
    "additional_enemy": MessageLookupByLibrary.simpleMessage("追加敵人"),
    ...
    "auth_admin_no_users": MessageLookupByLibrary.simpleMessage("未找到用户"),
    ...
    "auth_contact_device_uuid_hint": MessageLookupByLibrary.simpleMessage("您的设备 UUID（请在反馈中附上）"),
    "auth_contact_required_info_hint": MessageLookupByLibrary.simpleMessage("联系管理员时请提供您的用户名和新邮箱"),
    ...
    "auth_email_not_received_hint": MessageLookupByLibrary.simpleMessage("未收到驗證碼？請檢查垃圾郵件匣，或將我們的郵箱加入白名單後重新發送。"),
    ...
    "auth_invalid_credentials": MessageLookupByLibrary.simpleMessage("用户名或密码错误"),
    ...
    "auth_open_feedback": MessageLookupByLibrary.simpleMessage("打开反馈页面"),
    ...
    "auth_session_expired_message": MessageLookupByLibrary.simpleMessage("您的登录已过期，请重新登录。"),
    "auth_session_expired_title": MessageLookupByLibrary.simpleMessage("登录已过期"),
    ...
    "cache_icons": MessageLookupByLibrary.simpleMessage("暫存圖示"),
    ...
    "card_asset_status": MessageLookupByLibrary.simpleMessage("再臨階段圖示"),
    ...
    "carousel": MessageLookupByLibrary.simpleMessage("輪播圖"),
    ...
    "class_board": MessageLookupByLibrary.simpleMessage("職階星圖"),
    ...
    "command_code_short": MessageLookupByLibrary.simpleMessage("紋章"),
    ...
    "contact_information_not_filled": MessageLookupByLibrary.simpleMessage("聯絡方式未填寫"),
    ...
    "craft_essence_short": MessageLookupByLibrary.simpleMessage("禮裝"),
    ...
    "create_mooncell_summon": MessageLookupByLibrary.simpleMessage("創建Mooncell卡池"),
    ...
    "critical_team": MessageLookupByLibrary.simpleMessage("爆擊隊"),
    ...
    "database_not_downloaded_warning": MessageLookupByLibrary.simpleMessage("資料庫未下載，請重試。"),
    ...
    "disallow_mlb": MessageLookupByLibrary.simpleMessage("禁止滿破"),
    ...
    "download_cancelled": MessageLookupByLibrary.simpleMessage("已取消下載。"),
    "download_latest_gamedata_hint": MessageLookupByLibrary.simpleMessage("為確保相容性，更新前請升級至最新版APP"),
    ...
    "drops_warning_has_rare_enemy": MessageLookupByLibrary.simpleMessage("此關卡存在稀有或追加敵人，請切換版本以獲取正確的掉落資訊"),
    ...
    "ended": MessageLookupByLibrary.simpleMessage("已結束"),
    ...
    "enemy_only": MessageLookupByLibrary.simpleMessage("僅敵人"),
    ...
    "event_mural": MessageLookupByLibrary.simpleMessage("壁畫"),
    ...
    "event_raid": MessageLookupByLibrary.simpleMessage("伐柱戰"),
    ...
    "exclude_random_enemy_quests": MessageLookupByLibrary.simpleMessage("排除隨機敵人的關卡"),
    ...
    "favorite_teams": MessageLookupByLibrary.simpleMessage("收藏的隊伍"),
    "feedback_add_attachments": MessageLookupByLibrary.simpleMessage("e.g. 截圖等文件"),
    "feedback_contact": MessageLookupByLibrary.simpleMessage("聯絡方式"),
    ...
    "feedback_password_recovery_banner": MessageLookupByLibrary.simpleMessage("密码找回支持 — 请在反馈中附上您的用户名和设备 UUID"),
    ...
    "forced_update": MessageLookupByLibrary.simpleMessage("強制升級"),
    "forgot_password_hint": MessageLookupByLibrary.simpleMessage("請先閱讀FAQ中關於重設密碼的部分，再聯繫開發者提供相關資訊。"),
    ...
    "free_exchange_svt": MessageLookupByLibrary.simpleMessage("從者自選"),
    ...
    "game_data_not_found": MessageLookupByLibrary.simpleMessage("數據載入失敗, 請先前往遊戲數據頁面下載"),
    ...
    "general_next": MessageLookupByLibrary.simpleMessage("下一個"),
    "general_others": MessageLookupByLibrary.simpleMessage("其他"),
    "general_previous": MessageLookupByLibrary.simpleMessage("上一個"),
    ...
    "install_failed_to_start": MessageLookupByLibrary.simpleMessage("無法啟動系統安裝器。"),
    "install_permission_hint": MessageLookupByLibrary.simpleMessage(
      "直接安裝需要一次性的系統授權。請點擊「前往設定」，為 Chaldea 開啟「允許安裝未知應用」，返回後重新點擊安裝。",
    ),
    ...
    "item_exceed_hint": MessageLookupByLibrary.simpleMessage("計算規劃籤，可以設置不同材料的剩餘量(僅用於FQ規劃)"),
    ...
    "laplace_enemy_multi_ver_hint": MessageLookupByLibrary.simpleMessage(
      "注意本關卡有多種版本的敵人配置，查找隊伍或模擬時需注意切換到對應版本:\n點擊詳情-選取版本-點擊計算器按鈕。",
    ),
    ...
    "laplace_quest_complex_ai_hint": MessageLookupByLibrary.simpleMessage(
      "此關卡可能存在複雜機制和AI，極有可能無法準確模擬，請確保理解敵方AI/場地AI如何工作的前提下進行模擬和手動觸發AI技能。",
    ),
    "laplace_upload_td_multi_dmg_func_hint": MessageLookupByLibrary.simpleMessage(
      "以下從者寶具存在多段攻擊，請檢查最小和最大隨機數對NP回收等的影響，確保均能通關",
    ),
    ...
    "login_bonus": MessageLookupByLibrary.simpleMessage("登入獎勵"),
    "login_change_name": MessageLookupByLibrary.simpleMessage("修改使用者名稱"),
    ...
    "login_new_name": MessageLookupByLibrary.simpleMessage("新使用者名稱"),
    ...
    "login_password_error_confirm_mismatch": MessageLookupByLibrary.simpleMessage("兩次輸入的密碼不一致"),
    ...
    "login_username": MessageLookupByLibrary.simpleMessage("使用者名稱"),
    ...
    "network_force_online_hint": MessageLookupByLibrary.simpleMessage("當未檢測到網路連接時，App將預設處於離線模式"),
    "network_settings": MessageLookupByLibrary.simpleMessage("網路設定"),
    "network_status": MessageLookupByLibrary.simpleMessage("網路狀態"),
    ...
    "normal": MessageLookupByLibrary.simpleMessage("一般"),
    ...
    "not_started": MessageLookupByLibrary.simpleMessage("尚未開始"),
    ...
    "obtain": MessageLookupByLibrary.simpleMessage("獲取"),
    ...
    "open_settings": MessageLookupByLibrary.simpleMessage("前往設定"),
    ...
    "player_only": MessageLookupByLibrary.simpleMessage("僅玩家"),
    ...
    "project_homepage": MessageLookupByLibrary.simpleMessage("項目首頁"),
    ...
    "rare_enemy": MessageLookupByLibrary.simpleMessage("稀有敵人"),
    ...
    "save_current_team": MessageLookupByLibrary.simpleMessage("保存目前隊伍"),
    ...
    "select_skip": MessageLookupByLibrary.simpleMessage("不選擇以跳過該效果"),
    ...
    "setting_priority_tagging": MessageLookupByLibrary.simpleMessage("優先度備註"),
    ...
    "setting_split_ratio_hint": MessageLookupByLibrary.simpleMessage("僅適用於寬螢幕模式"),
    "setting_tabs_sorting": MessageLookupByLibrary.simpleMessage("標籤頁排序"),
    "settings_data": MessageLookupByLibrary.simpleMessage("資料"),
    "settings_documents": MessageLookupByLibrary.simpleMessage("使用文件"),
    ...
    "settings_userdata_footer": MessageLookupByLibrary.simpleMessage(
      "更新資料/版本/bug較多時，建議提前備份資料，移除應用將導致內部備份遺失，即時轉移到可靠的儲存位置",
    ),
    "share": MessageLookupByLibrary.simpleMessage("分享"),
    "shop": MessageLookupByLibrary.simpleMessage("商店"),
    "shop_free_condition": MessageLookupByLibrary.simpleMessage("免費條件"),
    ...
    "show_mc_campaign": MessageLookupByLibrary.simpleMessage("顯示紀念活動"),
    "show_more": MessageLookupByLibrary.simpleMessage("顯示更多"),
    "show_original_mission_text": MessageLookupByLibrary.simpleMessage("顯示原始任務內容"),
    ...
    "simulate_simple_ai": MessageLookupByLibrary.simpleMessage("模擬簡單AI"),
    ...
    "story_figure_manual_add_hint": MessageLookupByLibrary.simpleMessage("手動添加，若有錯請回饋"),
    "strength_status": MessageLookupByLibrary.simpleMessage("強化狀態"),
    "sub_attribute_advantage": MessageLookupByLibrary.simpleMessage("副屬性剋制"),
    "success": MessageLookupByLibrary.simpleMessage("成功"),
    "summon": MessageLookupByLibrary.simpleMessage("召喚"),
    "summon_banner": MessageLookupByLibrary.simpleMessage("卡池"),
    ...
    "svt_attribute": MessageLookupByLibrary.simpleMessage("屬性"),
    ...
    "svt_not_release_hint": MessageLookupByLibrary.simpleMessage("以下從者可能尚未實裝"),
    ...
    "svt_option_resync": MessageLookupByLibrary.simpleMessage("重新讀取配置"),
    ...
    "svt_stat_own_total": MessageLookupByLibrary.simpleMessage("(999)寶具/持有/總計"),
    "svt_sub_attribute": MessageLookupByLibrary.simpleMessage("副屬性"),
    ...
    "team_rare_enemy_warning": MessageLookupByLibrary.simpleMessage(
      "此關卡可能包含稀有或追加敵人，若為隨機出現（無法100%保證出現），請確保此隊伍可適用於所有可能的敵方配置。",
    ),
    "team_report_reason_hint": MessageLookupByLibrary.simpleMessage(
      "【詳細說明】使用未實裝從者xxx/操作發牌成功率低/無法通關 等等。\n為了通知管理員刪除隊伍而不是讓其修改隊伍配置。",
    ),
    "team_shared": MessageLookupByLibrary.simpleMessage("共享隊伍"),
    "team_starting_member": MessageLookupByLibrary.simpleMessage("前排"),
    ...
    "twice_skill_turn_3_hint": MessageLookupByLibrary.simpleMessage("從者釋放第二輪技能在T1或是T3"),
    ...
    "update_time": MessageLookupByLibrary.simpleMessage("更新時間"),
    ...
    "upload_team_critical_team_warning": MessageLookupByLibrary.simpleMessage("普通指令卡過多，請減少不必要出卡。若確實為爆擊隊請勾選:"),
    ...
    "userdata_sync_hint": MessageLookupByLibrary.simpleMessage("臨時備份！僅包含帳號數據，不包含本地設置，最多儲存1個星期內的3個最新備份"),
    ...
    "validation_email_invalid": MessageLookupByLibrary.simpleMessage("邮箱地址无效"),
    "validation_name_same_as_old": MessageLookupByLibrary.simpleMessage("新用户名不能与旧用户名相同"),
    "validation_no_whitespace": MessageLookupByLibrary.simpleMessage("不能包含空格"),
    "validation_password_format": MessageLookupByLibrary.simpleMessage("密码只能包含可打印 ASCII 字符"),
    "validation_password_length": MessageLookupByLibrary.simpleMessage("密码长度需为 6-18 字符"),
    "validation_password_not_all_digits": MessageLookupByLibrary.simpleMessage("密码不能全为数字"),
    "validation_password_same_as_old": MessageLookupByLibrary.simpleMessage("新密码不能与旧密码相同"),
    "validation_required": MessageLookupByLibrary.simpleMessage("必填"),
    "validation_too_long": MessageLookupByLibrary.simpleMessage("过长"),
    "validation_username_end_no_underscore": MessageLookupByLibrary.simpleMessage("用户名不能以下划线结尾"),
    "validation_username_format": MessageLookupByLibrary.simpleMessage("用户名只能包含字母、数字和下划线"),
    "validation_username_length": MessageLookupByLibrary.simpleMessage("用户名长度需为 4-18 字符"),
    "validation_username_not_all_digits": MessageLookupByLibrary.simpleMessage("用户名不能全为数字"),
    "validation_username_reserved": MessageLookupByLibrary.simpleMessage("该用户名已被保留"),
    "validation_username_start_letter": MessageLookupByLibrary.simpleMessage("用户名必须以字母开头"),
    ...
    "web_domain_choice_hint": MessageLookupByLibrary.simpleMessage("大陸地區請選擇國內節點\n網頁版僅推薦PC用戶使用，手機版網頁性能較差且bug較多如無故刷新"),
    "words_separate": m12,
    "xapk_cancel_and_pick": MessageLookupByLibrary.simpleMessage("取消下载并选择"),
    "xapk_cancel_download_to_pick": MessageLookupByLibrary.simpleMessage("文件正在下载中。是否取消下载并改为选择本地文件？"),
    "xapk_confirming": MessageLookupByLibrary.simpleMessage("请在系统弹窗中确认安装"),
    "xapk_error_confirm_activity_missing": MessageLookupByLibrary.simpleMessage(
      "设备安装器无法弹出确认窗口。MIUI 设备请到开发者选项关闭「MIUI 优化」后重试。",
    ),
    "xapk_error_crc_failed": MessageLookupByLibrary.simpleMessage("文件完整性校验失败（CRC），请重新下载"),
    "xapk_error_file_not_found": MessageLookupByLibrary.simpleMessage("文件不存在"),
    "xapk_error_missing_split": MessageLookupByLibrary.simpleMessage("清单中列出的拆分 APK 在文件中缺失"),
    "xapk_error_no_base_split": MessageLookupByLibrary.simpleMessage("清单中未找到基础 APK"),
    "xapk_error_no_manifest": MessageLookupByLibrary.simpleMessage("manifest.json 缺失或无效"),
    "xapk_error_not_zip": MessageLookupByLibrary.simpleMessage("不是有效的 XAPK 文件"),
    "xapk_error_obb_unsupported": MessageLookupByLibrary.simpleMessage(
      "该 XAPK 包含 OBB 扩展数据，暂不支持。请使用外部安装器（如 APKPure）安装。",
    ),
    "xapk_error_size_mismatch": MessageLookupByLibrary.simpleMessage("文件大小与清单不符，文件可能已损坏，请重新下载"),
    "xapk_error_timeout": MessageLookupByLibrary.simpleMessage("等待系统安装器超时"),
    "xapk_install_failed": MessageLookupByLibrary.simpleMessage("安装失败"),
    "xapk_install_success": MessageLookupByLibrary.simpleMessage("安装完成"),
    "xapk_install_title": MessageLookupByLibrary.simpleMessage("XAPK 安装"),
    "xapk_installing": MessageLookupByLibrary.simpleMessage("安装中..."),
    "xapk_no_install_permission_hint": MessageLookupByLibrary.simpleMessage(
      "从 Google Play 等商店下载的版本未声明安装权限，无法直接安装 APK/XAPK，请使用第三方安装工具。",
    ),
    "xapk_not_supported_hint": MessageLookupByLibrary.simpleMessage(
      "并非所有 XAPK 都支持直接安装（例如包含 OBB 扩展数据的 XAPK 不支持）。若解析或安装失败，请使用第三方安装工具，如 ApkPure App、APKCombo Installer、MT 管理器等，或参考 APK 安装页的帮助。",
    ),
    "xapk_package": MessageLookupByLibrary.simpleMessage("包名"),
    "xapk_parsed": MessageLookupByLibrary.simpleMessage("解析完成，可以安装"),
    "xapk_parsing": MessageLookupByLibrary.simpleMessage("解析中..."),
    "xapk_select_file": MessageLookupByLibrary.simpleMessage("选择 XAPK/APK 文件"),
    "xapk_total_size": MessageLookupByLibrary.simpleMessage("总大小"),
    "xapk_vendor_guidance_header": MessageLookupByLibrary.simpleMessage("设备兼容性说明"),
  };
}
