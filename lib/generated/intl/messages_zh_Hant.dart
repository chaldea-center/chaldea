...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(version, curVer) => "App版本需不低於${version} (目前: ${curVer})";

  static String m1(n) => "最多${n}池";

  static String m2(n, total) => "聖杯替換為傳承結晶 ${n}/${total} 個";

  static String m17(filename, hash, localHash) => "文件${filename}未找到或錯誤: ${hash} - ${localHash}";

  static String m18(rarity) => "${rarity}星禮裝PickUp";

  static String m19(rarity) => "${rarity}星從者PickUp";
  ...
  static String m21(shown, total) => "顯示${shown}/總計${total}";

  static String m22(shown, ignore, total) => "顯示${shown}/忽略${ignore}/總計${total}";
  ...
  static String m24(region) => "出現錯誤或${region}無此關卡資料";

  static String m25(runs) => "樣本數${runs}";

  static String m26(index, total, enemy) => "版本${index}/${total} (${enemy}敵人)";
  ...
  static String m28(battles, ap) => "總計${battles}次戰鬥, ${ap} AP";

  static String m11(n) => "個人資料${n}";

  static String m29(color, trait) => "此寶具顯示為${color}卡，但不持有[${trait}]特性";

  static String m30(trait) => "這是一個寶具，但不持有[${trait}]特性";

  static String m31(count) => "存在${count}張滿寶五星，分享隊伍應盡可能低配減配";

  static String m32(remain) => "上傳過於頻繁，請等待${remain}秒";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "add_not_svt_trait_to_traum_enemy": MessageLookupByLibrary.simpleMessage("添加Traum敵人的[非從者]特性"),
        ...
        "fix_cors_for_chaldea_data": MessageLookupByLibrary.simpleMessage("修復\"海外\"源的跨域請求網路錯誤"),
        "fix_cors_for_chaldea_data_hint": MessageLookupByLibrary.simpleMessage("一般出現在FireFox中"),
        ...
        "laplace_quest_complex_ai_hint":
            MessageLookupByLibrary.simpleMessage("此關卡可能存在複雜機制和AI，極有可能無法準確模擬，請確保理解敵方AI/場地AI如何工作的前提下進行模擬和手動觸發AI技能。"),
        ...
        "plan_list_set_all": MessageLookupByLibrary.simpleMessage("批次設置"),
        ...
        "screenshot_not_support_html_renderer": MessageLookupByLibrary.simpleMessage("截圖功能在html渲染模式中不可用"),
        ...
        "team_rare_enemy_warning":
            MessageLookupByLibrary.simpleMessage("此關卡可能包含稀有或追加敵人，若為隨機出現（無法100%保證出現），請確保此隊伍可適用於所有可能的敵方配置。"),
        ...
        "web_domain_choice_hint":
            MessageLookupByLibrary.simpleMessage("大陸地區請選擇國內節點\n網頁版僅推薦PC用戶使用，手機版網頁性能較差且bug較多如無故刷新"),
