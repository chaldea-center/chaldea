...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(count) => "Зарядить NP до ${count}";

  static String m24(version, curVer) => "Требуемая версия приложения: ≥ ${version} (Текущая: ${curVer})";
  ...
  static String m28(item) => "Возможный связанный ${item} \"УГАДАН\" на основе времени";
  ...
  static String m29(shown, total) => "${shown} показано (всего ${total})";

  static String m30(shown, ignore, total) => "${shown} показано, ${ignore} проигноророванно (всего ${total})";

  static String m6(first) =>
      "${Intl.select(first, {'true': 'Это уже первое', 'false': 'Это уже последнее', 'other': 'Больше нет'})}";

  static String m31(layer) => "Слой ${layer}";

  static String m7(n) => "Выбор ${n}";

  static String m32(region) => "Что-то пошло не так, или у ${region} нет данных об этом задании";

  static String m33(runs) => "Размер выборки: ${runs}";

  static String m34(index, total, enemy) => "Версия ${index}/${total} (${enemy} врагов)";
  ...
  static String m36(battles, ap) => "Всего ${battles} боев, ${ap} AP";
  ...
  static String m38(trait) => "Это Благородный Фантазм, но у него нет трейта [${trait}].";
  ...
  static String m40(remain) => "Слишком часто загружаетесь, пожалуйста, подождите ${remain} секунд";
