...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(account) => "Switched to account ${account}";

  static String m8(itemNum, svtNum) =>
      "Import ${itemNum} items and ${svtNum} svts to";

  static String m9(name) => "${name} already exist";

  static String m10(site) => "Jump to ${site}";
  ...
  static String m13(version) => "Updated dataset to ${version}";
  ...
  static String m17(total) => "Total ${total} results";

  static String m18(total, hidden) =>
      "Total ${total} results (${hidden} hidden)";

  static String m19(server) => "Sync with ${server}";
