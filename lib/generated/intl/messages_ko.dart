...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m15(filename, hash, localHash) => "${filename} 파일을 찾을 수 없거나 해시가 일치하지 않습니다 : ${hash} - ${localHash}";
  ...
  static String m19(shown, ignore, total) => "${shown} 표시, ${ignore} 무시 (합계 ${total})";
