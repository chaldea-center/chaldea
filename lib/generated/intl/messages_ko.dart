...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(count) => "NP 차지 ${count} 에게";

  static String m24(version, curVer) => "필요한 앱 버전 : ≥${version} (현재: ${curVer})";

  static String m1(n) => "최대 ${n}회 제한";

  static String m2(n, total) => "전승결정으로 대체되는 성배의 개수 : ${n}/${total}";

  static String m25(filename, hash, localHash) => "${filename} 파일을 찾을 수 없거나 해시가 일치하지 않습니다 : ${hash} - ${localHash}";

  static String m26(rarity) => "${rarity}☆ 개념예장 픽업";

  static String m27(rarity) => "${rarity}☆ 서번트 픽업";
  ...
  static String m29(shown, total) => "${shown} 표시 (합계 ${total})";

  static String m30(shown, ignore, total) => "${shown} 표시, ${ignore} 무시 (합계 ${total})";

  static String m6(first) => "${Intl.select(first, {'true': '이미 첫번째입니다.', 'false': '이미 마지막입니다.', 'other': '마지막입니다.'})}";

  static String m31(layer) => "제${layer}층";

  static String m7(n) => "제${n}절";

  static String m32(region) => "문제가 발생했거나 ${region}에 이 퀘스트의 데이터가 없습니다.";

  static String m33(runs) => "실행 횟수 {실행}";
  ...
  static String m36(battles, ap) => "합계 ${battles}회 전투, ${ap} AP";
