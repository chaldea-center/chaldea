...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(account) => "已切换到账号${account}";

  static String m8(itemNum, svtNum) => "导入${itemNum}个素材,${svtNum}从者到";

  static String m9(name) => "${name}已存在";

  static String m10(site) => "跳转到${site}";
  ...
  static String m13(version) => "已更新数据版本至${version}";

  static String m14(index) => "规划${index}";

  static String m15(n) => "重置规划${n}(所有)";

  static String m16(n) => "重置规划${n}(已显示)";

  static String m17(total) => "总计: ${total}";

  static String m18(total, hidden) => "总计: ${total} (隐藏: ${hidden})";
