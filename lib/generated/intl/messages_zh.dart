...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(version, curVer) => "App版本需不低于${version} (当前:${curVer})";

  static String m1(n) => "最多${n}池";

  static String m2(n, total) => "圣杯替换为传承结晶 ${n}/${total} 个";

  static String m24(filename, hash, localHash) => "文件${filename}未找到或错误: ${hash} - ${localHash}";

  static String m25(rarity) => "${rarity}星礼装PickUp";

  static String m26(rarity) => "${rarity}星从者PickUp";
  ...
  static String m28(shown, total) => "显示${shown}/总计${total}";

  static String m29(shown, ignore, total) => "显示${shown}/忽略${ignore}/总计${total}";

  static String m6(first) => "${Intl.select(first, {'true': '已经是第一张', 'false': '已经是最后一张', 'other': '已经到头了'})}";

  static String m30(layer) => "第${layer}层";

  static String m7(n) => "第${n}节";

  static String m31(region) => "出现错误或${region}无此关卡数据";

  static String m32(runs) => "样本数${runs}";

  static String m33(index, total, enemy) => "版本${index}/${total} (${enemy}敌人)";
  ...
  static String m35(battles, ap) => "总计${battles}次战斗, ${ap} AP";

  static String m11(n) => "个人资料${n}";

  static String m36(color, trait) => "此宝具显示为${color}卡，但不持有[${trait}]特性";

  static String m37(trait) => "这是一个宝具，但不持有[${trait}]特性";

  static String m38(count) => "存在${count}张满宝五星，分享队伍应尽可能低配减配";

  static String m39(remain) => "上传过于频繁，请等待${remain}秒";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "carousel": MessageLookupByLibrary.simpleMessage("轮播图"),
    ...
    "class_board": MessageLookupByLibrary.simpleMessage("职阶星图"),
    ...
    "default_lvs_hint": MessageLookupByLibrary.simpleMessage("默认等级仅在\"玩家数据\"禁用或从者/礼装未关注时使用"),
    ...
    "download_cancelled": MessageLookupByLibrary.simpleMessage("已取消下载。"),
    ...
    "edge_swipe_pop_gesture": MessageLookupByLibrary.simpleMessage("强制开启侧滑弹出页面"),
    ...
    "ended": MessageLookupByLibrary.simpleMessage("已结束"),
    ...
    "forgot_password_hint": MessageLookupByLibrary.simpleMessage("请先阅读FAQ中关于重置密码的部分，再联系开发者提供相关信息。"),
    ...
    "install_failed_to_start": MessageLookupByLibrary.simpleMessage("无法启动系统安装器。"),
    "install_permission_hint": MessageLookupByLibrary.simpleMessage(
      "直接安装需要一次性的系统授权。请点击「前往设置」，为 Chaldea 开启「允许安装未知应用」，返回后重新点击安装。",
    ),
    ...
    "laplace_enemy_multi_ver_hint": MessageLookupByLibrary.simpleMessage(
      "注意本关卡有多种版本的敌人配置，查找队伍或模拟时需注意切换到对应版本:\n点击详情-选取版本-点击计算器按钮。",
    ),
    ...
    "laplace_quest_complex_ai_hint": MessageLookupByLibrary.simpleMessage(
      "此关卡可能存在复杂机制和AI，极有可能无法准确模拟，请确保理解敌方AI/场地AI如何工作的前提下进行模拟和手动触发AI技能。",
    ),
    "laplace_upload_td_multi_dmg_func_hint": MessageLookupByLibrary.simpleMessage(
      "以下从者宝具存在多段攻击，请检查最小和最大随机数对NP回收等的影响，确保均能通关",
    ),
    ...
    "open_settings": MessageLookupByLibrary.simpleMessage("前往设置"),
    ...
    "rare_enemy": MessageLookupByLibrary.simpleMessage("稀有敌人"),
    ...
    "spirit_origin_release_quest": MessageLookupByLibrary.simpleMessage("灵基解放关卡"),
    ...
    "svt_attribute": MessageLookupByLibrary.simpleMessage("属性"),
    ...
    "team_rare_enemy_warning": MessageLookupByLibrary.simpleMessage(
      "此关卡可能包含稀有或追加敌人，若为随机出现（无法100%保证出现），请确保此队伍可适用于所有可能的敌方配置。",
    ),
    "team_report_reason_hint": MessageLookupByLibrary.simpleMessage(
      "【详细说明】使用未实装从者(说明哪位)/操作发牌成功率低/无法通关 等等。\n为了通知管理员删除队伍而不是让其修改队伍配置。",
    ),
    ...
    "web_domain_choice_hint": MessageLookupByLibrary.simpleMessage("大陆地区请选择国内节点\n网页版仅推荐PC用户使用，手机版网页性能较差且bug较多如无故刷新"),
    "words_separate": m12,
