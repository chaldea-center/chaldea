...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m8(first) => "${Intl.select(first, {'true': '已经是第一张', 'false': '已经是最后一张', 'other': '已经到头了', })}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "about_app_declaration_text" : MessageLookupByLibrary.simpleMessage("　本应用所使用数据均来源于游戏及以下网站，游戏图片文本原文等版权属于TYPE MOON/FGO PROJECT。\n　程序功能与界面设计参考微信小程序\"素材规划\"以及iOS版Guda。"),
    "about_appstore_rating" : MessageLookupByLibrary.simpleMessage("App Store评分"),
    ...
    "about_email_subtitle" : MessageLookupByLibrary.simpleMessage("请附上出错页面截图和日志"),
    "about_feedback" : MessageLookupByLibrary.simpleMessage("反馈"),
    "about_update_app" : MessageLookupByLibrary.simpleMessage("应用更新"),
    "about_update_app_alert_ios_mac" : MessageLookupByLibrary.simpleMessage("请在App Store中检查更新"),
    ...
    "dataset_goto_download_page" : MessageLookupByLibrary.simpleMessage("前往下载页"),
    "dataset_goto_download_page_hint" : MessageLookupByLibrary.simpleMessage("下载后手动导入"),
    ...
    "dataset_type_entire_hint" : MessageLookupByLibrary.simpleMessage("包含文本和图片，~25M"),
    ...
    "download_source_hint" : MessageLookupByLibrary.simpleMessage("游戏数据和应用更新"),
    ...
    "event_item_default" : MessageLookupByLibrary.simpleMessage("商店/任务/点数/关卡掉落奖励"),
    ...
    "feedback_add_attachments" : MessageLookupByLibrary.simpleMessage("添加图像或文件附件"),
    "feedback_add_crash_log" : MessageLookupByLibrary.simpleMessage("添加崩溃日志"),
    ...
    "hint_no_valentine_craft" : MessageLookupByLibrary.simpleMessage("无情人节礼装"),
    ...
    "login_password_error" : MessageLookupByLibrary.simpleMessage("只能包含字母与数字，不少于4位"),
    ...
    "settings_data_management" : MessageLookupByLibrary.simpleMessage("数据管理"),
    ...
    "settings_use_mobile_network" : MessageLookupByLibrary.simpleMessage("使用移动数据下载"),
    ...
    "svt_obtain_friend_point" : MessageLookupByLibrary.simpleMessage("友情点召唤"),
    ...
    "tooltip_refresh_sliders" : MessageLookupByLibrary.simpleMessage("刷新首页图"),
