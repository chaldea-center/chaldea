...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m13(email) => "验证码已发送至 ${email}。";

  static String m14(count, total) => "${total}张指令卡中有${count}张未攻击，请减少不必要的指令卡";

  static String m15(kstar) => "5${kstar}英灵召唤";

  static String m16(kstar) => "5${kstar}英灵召唤概率";

  static String m17(kstar) => "5${kstar}契约/宝具数";

  static String m18(year) => "${year}年";

  static String m19(curYear) => "${curYear}抽卡";

  static String m20(curYear) => "${curYear}年度";

  static String m21(curYear, count) => "${curYear}抽卡次数前${count}";

  static String m22(year, month, day) => "入职${year}年${month}月${day}天";

  static String m0(url) => "Chaldea——一款跨平台的Fate/GO素材规划客户端，支持游戏信息浏览、从者练度/活动/素材规划、周常规划、抽卡模拟器等功能。\n\n详情请见: \n${url}\n";

  static String m23(count) => "充能至${count}";

  static String m24(version, curVer) => "App版本需不低于${version} (当前:${curVer})";

  static String m1(n) => "最多${n}池";

  static String m2(n, total) => "圣杯替换为传承结晶 ${n}/${total} 个";

  static String m25(filename, hash, localHash) => "文件${filename}未找到或错误: ${hash} - ${localHash}";

  static String m26(rarity) => "${rarity}星礼装PickUp";

  static String m27(rarity) => "${rarity}星从者PickUp";

  static String m28(item) => "根据时间“推测”的可能关联的${item}";
  ...
  static String m29(shown, total) => "显示${shown}/总计${total}";

  static String m30(shown, ignore, total) => "显示${shown}/忽略${ignore}/总计${total}";

  static String m6(first) => "${Intl.select(first, {'true': '已经是第一张', 'false': '已经是最后一张', 'other': '已经到头了'})}";

  static String m31(layer) => "第${layer}层";

  static String m7(n) => "第${n}节";

  static String m32(region) => "出现错误或${region}无此关卡数据";

  static String m33(runs) => "样本数${runs}";

  static String m34(index, total, enemy) => "版本${index}/${total} (${enemy}敌人)";
  ...
  static String m36(battles, ap) => "总计${battles}次战斗, ${ap} AP";

  static String m11(n) => "个人资料${n}";

  static String m37(color, trait) => "此宝具显示为${color}卡，但不持有[${trait}]特性";

  static String m38(trait) => "这是一个宝具，但不持有[${trait}]特性";

  static String m39(count) => "存在${count}张满宝五星，分享队伍应尽可能低配减配";

  static String m40(remain) => "上传过于频繁，请等待${remain}秒";
