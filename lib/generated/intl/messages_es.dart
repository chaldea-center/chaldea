...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m29(shown, total) => "${shown} mostrado (total ${total})";

  static String m30(shown, ignore, total) => "${shown} mostrado, ${ignore} ignorado (total ${total})";
  ...
  static String m36(battles, ap) => "Total de batallas: ${battles}, ${ap} AP";
