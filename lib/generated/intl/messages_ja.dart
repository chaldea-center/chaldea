...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "dataset_type_entire":
            MessageLookupByLibrary.simpleMessage("完全なデータパッケージ"),
        "dataset_type_entire_hint":
            MessageLookupByLibrary.simpleMessage("テキストと画像を含める、約25M"),
        "dataset_type_text":
        ...
        "delete_all_data_hint": MessageLookupByLibrary.simpleMessage(
            "ユーザーデータ、ゲームデータ、画像リソースを含め、デフォルトのリソースを読み込む"),
        ...
        "guda_item_data": MessageLookupByLibrary.simpleMessage("アイテムデータ"),
        "guda_servant_data": MessageLookupByLibrary.simpleMessage("サーヴァントデータ"),
        ...
        "import_guda_data":
            MessageLookupByLibrary.simpleMessage("Gudaデータをインポート"),
        "import_guda_hint": MessageLookupByLibrary.simpleMessage(
            "更新：保留本地数据并用导入的数据更新(推荐)\n覆盖：清楚本地数据再导入数据"),
        "import_guda_items":
            MessageLookupByLibrary.simpleMessage("アイテムデータをインポート"),
        "import_guda_servants":
            MessageLookupByLibrary.simpleMessage("サーヴァントデータをインポート"),
