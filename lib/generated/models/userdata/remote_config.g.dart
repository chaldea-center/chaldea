...
ServerUrlConfig _$ServerUrlConfigFromJson(Map json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = ServerUrlConfig(
          ...
          worker: $checkedConvert(
              'worker', (v) => v == null ? null : UrlProxy.fromJson(Map<String, dynamic>.from(v as Map))),
          data:
              $checkedConvert('data', (v) => v == null ? null : UrlProxy.fromJson(Map<String, dynamic>.from(v as Map))),
          atlasApi: $checkedConvert(
              'atlasApi', (v) => v == null ? null : UrlProxy.fromJson(Map<String, dynamic>.from(v as Map))),
          atlasAsset: $checkedConvert(
              'atlasAsset', (v) => v == null ? null : UrlProxy.fromJson(Map<String, dynamic>.from(v as Map))),
        );
        return val;
      },
    );
...
UrlProxy _$UrlProxyFromJson(Map json) => $checkedCreate(
      'UrlProxy',
      json,
      ($checkedConvert) {
