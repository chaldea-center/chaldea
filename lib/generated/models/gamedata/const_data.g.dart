...
GameConstants _$GameConstantsFromJson(Map json) => GameConstants(
  ...
  comebackTargetDay: (json['comebackTargetDay'] as num?)?.toInt() ?? 1774861200,
  ...
  exRoomFeatureReleaseCommonId: (json['exRoomFeatureReleaseCommonId'] as num?)?.toInt() ?? 20160502,
  exRoomFirstEffectQuestId: (json['exRoomFirstEffectQuestId'] as num?)?.toInt() ?? 94158821,
  exRoomReleaseCommonId: (json['exRoomReleaseCommonId'] as num?)?.toInt() ?? 20160501,
  fesWarId: (json['fesWarId'] as num?)?.toInt() ?? 108,
  figureUseSimpleMesh: (json['figureUseSimpleMesh'] as num?)?.toInt() ?? 1,
  ...
  flag20260802: (json['flag20260802'] as num?)?.toInt() ?? 1,
  ...
  friendNum: (json['friendNum'] as num?)?.toInt() ?? 46,
  ...
  ignoreResumePauseOnStop: (json['ignoreResumePauseOnStop'] as num?)?.toInt() ?? 0,
  ...
  lastWarId: (json['lastWarId'] as num?)?.toInt() ?? 501,
  ...
  loginDay: (json['loginDay'] as num?)?.toInt() ?? 1774969200,
  ...
  maxUserCommandCode: (json['maxUserCommandCode'] as num?)?.toInt() ?? 1100,
  ...
  maxUserSvt: (json['maxUserSvt'] as num?)?.toInt() ?? 1100,
  maxUserSvtEquip: (json['maxUserSvtEquip'] as num?)?.toInt() ?? 1100,
  ...
  photoStandFigureZoomRateMax: (json['photoStandFigureZoomRateMax'] as num?)?.toInt() ?? 2000,
  photoStandFigureZoomRateMin: (json['photoStandFigureZoomRateMin'] as num?)?.toInt() ?? 500,
  ...
  startDashSummon3PrivilegeId: (json['startDashSummon3PrivilegeId'] as num?)?.toInt() ?? 400,
...
Map<String, dynamic> _$GameConstantsToJson(GameConstants instance) => <String, dynamic>{
  ...
  'exRoomFeatureReleaseCommonId': instance.exRoomFeatureReleaseCommonId,
  'exRoomFirstEffectQuestId': instance.exRoomFirstEffectQuestId,
  'exRoomReleaseCommonId': instance.exRoomReleaseCommonId,
  'fesWarId': instance.fesWarId,
  'figureUseSimpleMesh': instance.figureUseSimpleMesh,
  ...
  'flag20260802': instance.flag20260802,
  ...
  'ignoreResumePauseOnStop': instance.ignoreResumePauseOnStop,
  ...
  'photoStandFigureZoomRateMax': instance.photoStandFigureZoomRateMax,
  'photoStandFigureZoomRateMin': instance.photoStandFigureZoomRateMin,
  ...
  'startDashSummon3PrivilegeId': instance.startDashSummon3PrivilegeId,
...
GameConstantStr _$GameConstantStrFromJson(Map json) => GameConstantStr(
  ...
  exRoomWarIds: (json['exRoomWarIds'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [1007],
...
Map<String, dynamic> _$GameConstantStrToJson(GameConstantStr instance) => <String, dynamic>{
  ...
  'exRoomWarIds': instance.exRoomWarIds,
