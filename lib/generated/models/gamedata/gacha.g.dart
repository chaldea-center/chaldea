...
MstShop _$MstShopFromJson(Map json) => MstShop(
  itemIds: (json['itemIds'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [],
  prices: (json['prices'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList() ?? const [],
  ...
  priority: (json['priority'] as num?)?.toInt() ?? 0,
  purchaseType: (json['purchaseType'] as num?)?.toInt() ?? 0,
  setNum: (json['setNum'] as num?)?.toInt() ?? 0,
  payType: (json['payType'] as num?)?.toInt() ?? 0,
  shopType: (json['shopType'] as num?)?.toInt() ?? 0,
  limitNum: (json['limitNum'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$MstShopToJson(MstShop instance) => <String, dynamic>{
