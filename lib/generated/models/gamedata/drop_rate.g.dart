...
DropRateSheet _$DropRateSheetFromJson(Map json) => DropRateSheet(
  ...
  sparseMatrix:
      (json['sparseMatrix'] as Map?)?.map(
        (k, e) => MapEntry(
          int.parse(k as String),
          (e as Map).map((k, e) => MapEntry(int.parse(k as String), (e as num).toDouble())),
        ),
      ) ??
      const {},
);
...
Map<String, dynamic> _$DropRateSheetToJson(DropRateSheet instance) => <String, dynamic>{
  ...
  'exps': instance.exps,
  'sparseMatrix': instance.sparseMatrix.map(
...
QuestDropData _$QuestDropDataFromJson(Map json) => QuestDropData(
  ...
  items: (json['items'] as Map?)?.map((k, e) => MapEntry(int.parse(k as String), (e as num).toInt())) ?? const {},
  groups: (json['groups'] as Map?)?.map((k, e) => MapEntry(int.parse(k as String), (e as num).toInt())) ?? const {},
);
