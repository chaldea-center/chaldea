...
NiceScript _$NiceScriptFromJson(Map json) => NiceScript(
  ...
  quests: (json['quests'] as List<dynamic>).map((e) => Quest.fromJson(Map<String, dynamic>.from(e as Map))).toList(),
);
...
ScriptLink _$ScriptLinkFromJson(Map json) =>
    ScriptLink(scriptId: json['scriptId'] as String, script: json['script'] as String?);
