...
(function () {
  ...
  class FlutterLoader {
    ...
    loadEntrypoint(options) {
      const {
        entrypointUrl = window.entrypointUrl, // save entrypointUrl globally, rather hard coded "main.dart.js"
        serviceWorker,
      } = options || {};
    ...
    _loadEntrypoint(entrypointUrl) {
      if (!this._scriptLoaded) {
        ...
        this._scriptLoaded = new Promise((resolve, reject) => {
          ...
          // mod: remove indicator after loaded
          scriptTag.onload = () => {
    ...
    _loadWithServiceWorker(entrypointUrl, serviceWorkerOptions) {
      ...
      const { serviceWorkerVersion, timeoutMillis = 4000 } = serviceWorkerOptions;
